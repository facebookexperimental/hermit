...
for ((i=0; i<20; i++)); do hermit run --chaos --seed-from=SystemRandom ./target/debug/hello_race; done
```
...
This is one place where contributions would be more than welcome! We could use
buck/bazel or some other testing system to encode our CI configuration.
