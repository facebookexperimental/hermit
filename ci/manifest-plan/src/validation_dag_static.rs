...
pub(super) const NEXTEST_EXPECTED_COUNTS: &[(&str, u64)] = &[
    ...
    ("test.regular_crates", 455),
    ("test.hermit_unit", 527),
    ("test.detcore_unit", 667),
    ("test.detcore_misc", 27),
    ("test.detcore_parallel", 5),
    ("test.hermit_integration", 149),
    ...
    ("test.hermit_integration_on_host", 149),
    ("test.hermit_unit_on_host", 527),
    ("test.ignored_syscall_regressions_on_host", 4),
    ("test.liteinst_strict_on_host", 24),
    ("test.regular_crates_on_host", 455),
