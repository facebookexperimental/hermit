...
# 2026-08-04 build.dbi_release and rr_suite_contract both completed at j8 under
# their cgroup-recorded memory caps. Memory-cap derivations must record this K.
