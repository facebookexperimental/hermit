...
function run_hosted_only_suite {
    ...
    run_check "Portable Hermit integration targets" run_hermit_targets_serial chaos_sched_yield_progress chaos_stress_pmu_detection clock_determinism clock_discipline_determinism epoll_determinism file_nr_determinism fp_reduction_determinism futex2_refusal hashseed_determinism mmap_determinism process_isolation_refusals procfs_determinism python_stdlib signal_determinism softnet_stat_determinism sockstat_determinism
