...
The selector covers exactly 465 of the 877 Cargo-discovered cases:
...
| Portable Hermit integration cases | 116 | Non-KVM CLI, non-python3-verify LiteInst, strict/verify modes, futex2 refusal, non-JVM apps, commands, time, memory, procfs, signals, Python, and rr source contract |
